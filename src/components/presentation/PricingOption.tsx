  ...
  return (
    <div 
      className={cn(
        ...
        recommended ? "border-vet-primary-purple bg-vet-soft-purple shadow-lg scale-105" : "border-gray-200 bg-white hover:shadow-md",
        className
      )}
    >
      {recommended && (
        <div className="bg-vet-primary-purple text-white py-1 px-4 rounded-full text-sm font-bold inline-block mb-4">
          Recommended
        </div>
      )}
      ...
      <div className="mb-2">
        ...
        {monthlyPrice && (
          <div className="text-vet-neutral-gray">+ {monthlyPrice}</div>
        )}
      </div>
      {children}
    </div>
